-- Update the check_and_update_nomination_cycles function to handle timezones correctly
...
BEGIN
  ...
  IF settings_record.next_nomination_start_date AT TIME ZONE 'Europe/Paris' <= paris_current_time AND 
...
-- Exécuter la fonction avec la nouvelle gestion des timezones
