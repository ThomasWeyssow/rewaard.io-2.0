...
import { NextNominationArea } from './NextNominationArea';
import { OngoingNominationArea } from './OngoingNominationArea';
...
export function SettingsPage() {
  ...
  const handleSelectNextNominationArea = async (
    areaId: string, 
    startDate: string, 
    endDate: string,
    ...
    await selectNextNominationArea(areaId, startDate, nominationPeriod);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-violet-900">Settings</h1></div>
      ...
      <div className="sticky top-0 z-10 bg-gray-100 pt-6 pb-4 -mx-4 px-4 -mt-6">
        <NextNominationArea
          ...
          onSelect={canModifySettings ? handleSelectNextNominationArea : undefined}
