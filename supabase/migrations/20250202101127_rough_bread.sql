...
-- Update existing settings to recalculate dates
UPDATE settings 
SET next_nomination_start_date = CURRENT_TIMESTAMP + INTERVAL '1 minute'
WHERE next_nomination_start_date IS NULL 
OR next_nomination_start_date < CURRENT_TIMESTAMP;