...
SELECT 
  ...
  to_char(CURRENT_TIMESTAMP at time zone 'Europe/Paris', 'YYYY-MM-DD HH24:MI:SS') as "Heure actuelle",
...
-- Afficher les derniers résultats de nomination
SELECT 
  to_char(nr.cycle_start_date at time zone 'Europe/Paris', 'YYYY-MM-DD HH24:MI:SS') as cycle_start,
  to_char(nr.cycle_end_date at time zone 'Europe/Paris', 'YYYY-MM-DD HH24:MI:SS') as cycle_end,
